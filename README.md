...
- La implementación del ciclo de vida Pipeline-supported, Experiment-Driven To-Be Software Platform Lifecycle permitió consolidar a Moveo como una plataforma orientada a la mejora continua. En este avance, las mejoras experimentales ya no quedaron solo como propuestas, sino que fueron organizadas en un To-Be Sprint Backlog, implementadas en la Landing Page, Frontend-Web, Native-Mobile y RESTful API, y vinculadas con evidencias de colaboración del equipo. Esto demuestra que el proyecto avanzó hacia una lógica más profesional, donde cada cambio puede pasar por integración, despliegue, validación y medición antes de considerarse una mejora definitiva.

- Las entrevistas de validación To-Be permitieron comprobar que las mejoras implementadas aportan directamente a la claridad, confianza y usabilidad de Moveo. Elementos como el botón visible de reserva, las acciones claras en las cards, el resumen antes de cancelar, la confirmación posterior a la cancelación, el número de seguimiento de tickets, las categorías de soporte y las descripciones accesibles en imágenes fortalecen la experiencia del usuario. Esto evidencia que el producto no solo mejora técnicamente, sino que también responde mejor a situaciones reales de uso, reduciendo incertidumbre en procesos sensibles como reservar, cancelar o reportar incidencias.

- Se recomienda mantener la instrumentación de analítica definida para los experimentos, especialmente en las historias HU33 a HU39 y TS05, con el fin de medir si las mejoras realmente generan impacto en la conversión, la confianza del usuario, la reducción de abandono y la eficiencia del soporte. No basta con implementar cambios visuales o funcionales; cada mejora debe evaluarse con indicadores concretos para decidir si se mantiene, se ajusta o se descarta en futuras iteraciones.
